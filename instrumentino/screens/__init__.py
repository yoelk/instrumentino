...
class MultipleViewManager(ScreenManager):
    '''Enables dynamically adding/removing views from the screen by pressing on toggle buttons (view choosers) in the
    sidebar. Splitters separate between concurrent views on screen.
    '''
