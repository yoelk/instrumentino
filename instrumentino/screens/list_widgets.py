...
class VariableValueDisplayWidget(SelectableView):
    ...
    def __init__(self, **kwargs):
        ...
        self.disabled = (self.variable.channel_out is None and self.variable.channel_in is not None)
...
class CompositeListItemMember(SelectableView):
...
class ListItemVariableSingleLineTextInput(VariableValueDisplayWidget, CompositeListItemMember, TextInput):
    ...
    def on_user_focus(self, instance, value):
        ...
        if not self.variable.user_is_editing:
...
class ListItemVariableDurationInput(ListItemVariableSingleLineTextInput):
    ...
    def insert_text(self, substring, from_undo=False):
        ...
        new_stripped_text = re.sub(pattern, '', self.text[:cc]) + stripped_substring + re.sub(pattern, '',
                                                                                              self.text[cc:])[
                                                                                       len(stripped_substring):]
